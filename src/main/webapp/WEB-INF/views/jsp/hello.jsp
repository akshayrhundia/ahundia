...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
              content="This is profile page of Akshay Hundia.">
        <meta name="author" content="Akshay Hundia">
        <meta name="keywords"
    ...
    <body id="page-top" class="index">
                        ...
                        <div class="intro-text">
                            ...
                            <p>
                                <b>Software Engineer with 7+ years of experience in designing
                                    ...
                                    solve real world issues. My current focus area is building cloud based enterprise
                                    solutions.</b>
                            </p>
                            <hr class="star-light">
        ...
        <section id="current">
            <div class="container">
                ...
                <div class="col-sm-4 portfolio-item">
                    <div style="vertical-align: middle; text-align: center; margin-top:15%; margin-bottom:15%;">
                        <img src="resources/img/amazon.png" class="img-responsive" alt=""
                             style="display: block; margin-left: auto; margin-right: auto;">
                        <br/>
                        <p>
                            <a href="#amazonModal" class="portfolio-link" data-toggle="modal">

                                Software Development Engineer - II</a>
                        </p>

                        <a href="#amazonModal" data-toggle="modal">

                            What I do at Amazon?</a>
                    </div>
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="col-sm-4 portfolio-item">
                            <a href="#capModal" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="resources/img/kp.png" class="img-responsive" alt=""
                ...
                <div class="row">
                    <div class="col-sm-4 portfolio-item">
                        <a href="#ddcModal" class="portfolio-link" data-toggle="modal">
                            ...
                            <img src="resources/img/replication.svg" class="img-responsive"
                                 alt=""
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <a href="#pittModal" class="portfolio-link" data-toggle="modal">
                            ...
                            <img src="resources/img/kafka.png" class="img-responsive" alt=""
                                 style="height: 230px; width: 400px; display: block; margin-left: auto; margin-right: auto;">
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <a href="#docModal" class="portfolio-link"
                           data-toggle="modal">
                            ...
                            <img src="resources/img/database.png" class="img-responsive"
                                 alt=""
                                 style="height: 230px; width: 400px; display: block; margin-left: auto; margin-right: auto;">
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <a href="#portfolioModal4" class="portfolio-link"
                           data-toggle="modal">
                            ...
                            <img src="resources/img/webservices.png" class="img-responsive"
                                 alt=""
                                 style="height: 230px; width: 400px; display: block; margin-left: auto; margin-right: auto;">
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <a href="#portfolioModal5" class="portfolio-link"
                           data-toggle="modal">
                            ...
                            <img src="resources/img/big-data.png" class="img-responsive"
                                 alt=""
                                 style="height: 230px; width: 400px; display: block; margin-left: auto; margin-right: auto;">
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <a href="#portfolioModal6" class="portfolio-link"
                           data-toggle="modal">
                            ...
                            <img src="resources/img/ma.jpg" class="img-responsive" alt=""
                                 style="height: 230px; width: 400px; display: block; margin-left: auto; margin-right: auto;">
        ...
        <section class="success" id="skills">
            <div class="container" style="padding-top:5%;padding-bottom:5%;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <p>Amazon Web Services, Google Cloud, Microsoft Azure</p>
                    </div>
                </div>
        ...
        <section id="job">
                ...
                <div class="row">
                    <div class="col-sm-4 portfolio-item">
                        <div style="vertical-align: middle; text-align: center;">
                            ...
                            <a href="https://www.slb.com">Schlumberger</a>
                        </div>
                    ...
                    <div class="col-sm-4 portfolio-item">
                        ...
                        <div style="vertical-align: middle; text-align: center;">
                            ...
                            <a
                                    href="http://www.samsung.com/in/aboutsamsung/home/">Samsung Research and Development
                                Institute </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container" style="margin-top:50px;">
                ...
                <div class="col-sm-4 portfolio-item">
                    ...
                    <div style="vertical-align: middle; text-align: center;">
                        <img src="resources/img/sf.png" class="img-responsive" alt=""
                             style="height:150px;display: block; margin-left: auto; margin-right: auto;">
                        <br/>
                        <p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="footer-col col-md-6">
                            <h3>Location</h3>
                            <p>
                                5 Fan Pier Blvd <br> Unit 824 <br>Boston, MA 02210
                            </p>
                        </div>
                        <div class="footer-col col-md-6">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>DELFI is cloud based cognitive solution to enable Machine Learning & Data Analytics on
                                exploration and production data.</p>
                            <p>It is a multi-tenant solution build leveraging Google Cloud Project and SOA architecture.
                                This platform has enabled end users to extract meaningful information from their
                                data.</p>

                        </div>
                        <div class="col-md-6" style='text-align:left;'>
                            <h4>My Contribution</h4>
                            <b>Technology:</b>Java and Python,Google compute engine,Google datastore,Google App
                            Engine,Google Dataflow,Google Stackdriver,Redis/Memcache,Key Management
                            System,Kubernetes,Hyperledger composer / Blockchain
                            <br/><br/>

                            <b>Role:</b>Cloud Software Engineer responsible for building foundation micro-services for
                            the new cloud-based (multi-tenant) cognitive E&P environment called DELFI.
                            <br/><br/>

                            <b>Responsibilities:</b>
                            <ul style='text-align:left;'>
                                <li> Implemented core APIs for DELFI Datalake, which enabled ingestion and discovery of
                                    large, fluid and unstructured data into the datalake.
                                </li>
                                <li>Designed and built micro-services for data indexing in an efficient manner which
                                    provided fast data access to end users.
                                </li>
                                <li>Implemented record level authorization which provided fine-grained control for
                                    sensitive data.
                                </li>
                                <li>Implemented search capabilities such as Geo Spacial, Geo Location, Bounding Box etc,
                                    which drastically increased the user experience.
                                </li>
                                <li>Leveraged Hyperledger composer (Blockchain) framework for implementing POC for data
                                    trading platform.
                                </li>
                            </ul>
                            ...
                            <ul class="list-inline item-details">
                                ...
                                <li>End Date: <strong>June 2019 </strong></li>
        ...
        <!-- Portfolio Modals -->
        <div class="portfolio-modal modal fade" id="amazonModal" tabindex="-1"
             role="dialog" aria-hidden="true">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h4>
                                <a href="https://www.amazon.jobs/en/teams/people-technology">People Technology</a>
                            </h4>
                            <hr class="star-primary">
                            <img src="resources/img/amazonPTech.jpg"
                                 class="img-responsive img-centered" alt="" style="height:200px;">
                            <p>Every day, hundreds of thousands of diverse Amazonians all over the world come to work
                                and obsess over our customers. People Tech is the engine that powers that customer
                                obsession. We work backwards from the customer to help Amazonians find their passion,
                                while building and growing their careers. We are lucky to see our end users every day,
                                and experience the lives we touch. Welcome to People Technology.</p>

                        </div>
                        <div class="col-md-6" style='text-align:left;'>
                            <h4>My Contribution</h4>
                            <b>Technology:</b>Java,AWS (EC2, DynamoDB, Route53, Lambda, Cloudwatch)
                            <br/><br/>

                            <b>Role:</b>SDE responsible for building foundation micro-services for the new people
                            technology platform.
                            <br/><br/>

                            <b>Responsibilities:</b>
                            <ul style='text-align:left;'>
                                <li> Implemented core APIs for Hire and Onboarding, which enabled 1000s of new hires
                                    (both at full-fillment center and corporate employees) into Amazon.
                                </li>
                            </ul>

                            <ul class="list-inline item-details">

                                <li>Start Date: <strong>June 2019 </strong>
                                </li>
                                <li>Service: <strong>Hire and Onboarding
                                </strong>
                                </li>
                            </ul>
                            <button type="button" class="btn btn-default"
                            ...
                            <div class="modal-body">
                                ...
                                <ul style="text-align: left;">
                                    ...
                                    <li>Newsmakers and media outlets and journalists can give
                                        feedback to each other on a five-point scale.
                                    </li>
                                    ...
                                    <li>Members are able to maintain connections with
                                        journalists regardless of a change of employment or career.
                                    </li>
                                    ...
                                    <li>Kent Parker increases transparency by allowing all
                                        ...
                                        initial pitches and the resulting news stories.
                                    </li>
                                </ul>
                                <ul class="list-inline item-details">
